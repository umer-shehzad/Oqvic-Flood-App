        ...
        <>
            <div className='d-flex flex-column align-items-center text-style mx-auto'>
                ...
                <input
                    ...
                    className='input-page9 w-50 me-4'
                ...
                <input
                    ...
                    className='input-page9 w-50 me-4 mb-2'
                ...
                />
                <p className='para4-page9 w-50 me-4 mb-2'>You will receive your quote once you click submit. If we need more information to provide you with a quote, we'll be in touch.</p>
            </div>
        </>
    )
}
